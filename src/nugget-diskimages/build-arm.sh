...
if [ ! -f ./packer-binaries/arm-packer ]; then
    ...
    mv packer packer-binaries/arm-packer
fi
...
./packer-binaries/arm-packer init ./packer-scripts/arm-ubuntu.pkr.hcl

# Build the image with the specified Ubuntu version
./packer-binaries/arm-packer build ./packer-scripts/arm-ubuntu.pkr.hcl
